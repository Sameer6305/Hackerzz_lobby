      ...
      <div className="max-w-3xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="flex items-center gap-3 mb-6">
            <button onClick={() => navigate('/profile')} className="p-2 rounded-lg text-label hover:text-heading hover:surface-elevated transition">
              <ArrowLeft size={20} />
            </button>
            <div>
              <h1 className="text-2xl font-bold text-heading">Edit Profile</h1>
              <p className="text-hint text-sm">Update your personal information</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="surface-card border border-theme rounded-xl p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    className="w-full px-4 py-2.5 rounded-xl surface-elevated border border-theme-secondary text-heading text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
                    value={form.username}
                ...
                <div>
                  ...
                  <input
                    className="w-full px-4 py-2.5 rounded-xl surface-elevated border border-theme-secondary text-hint text-sm cursor-not-allowed"
                    value={user?.email || ''}
                    disabled
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-body mb-1.5">College</label>
                  <input
                    className="w-full px-4 py-2.5 rounded-xl surface-elevated border border-theme-secondary text-heading text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
                    value={form.college}
                ...
                <div className="sm:col-span-2">
                  <label className="block text-sm font-medium text-body mb-1.5">Bio</label>
                  <textarea
                    className="w-full px-4 py-2.5 rounded-xl surface-elevated border border-theme-secondary text-heading text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 resize-none"
                    rows={3}
                    value={form.bio}
            ...
            <div className="surface-card border border-theme rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <Github size={18} className="text-label flex-shrink-0" />
                  <input
                    className="w-full px-4 py-2.5 rounded-xl surface-elevated border border-theme-secondary text-heading text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
                    value={form.github}
                ...
                <div className="flex items-center gap-3">
                  <Linkedin size={18} className="text-label flex-shrink-0" />
                  <input
                    className="w-full px-4 py-2.5 rounded-xl surface-elevated border border-theme-secondary text-heading text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
                    value={form.linkedin}
                ...
                <div className="flex items-center gap-3">
                  <Globe size={18} className="text-label flex-shrink-0" />
                  <input
                    className="w-full px-4 py-2.5 rounded-xl surface-elevated border border-theme-secondary text-heading text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-sm transition-all ${
                      selectedSkills.includes(skill)
                        ...
                        : 'surface-elevated text-label border border-theme-secondary hover:border-gray-500'
                    }`}
                  >
                    {skill}
                  </button>
            ...
            <div className="flex justify-end gap-3">
              <Button type="button" variant="ghost" onClick={() => navigate('/profile')} className="text-label">
                Cancel
              </Button>
